...
- `/workbench/options` consumers rely on `direction_parameters`, `defense_parameters`, `compatibility_matrix`, and Amazon target item fields such as `raw_title`, `display_name_zh`, `short_name_zh`, `category_zh`, `image_url`, and `thumbnail_url`.
